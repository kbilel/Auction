...
//		user3.setImageUrl("khaled.jpg");
	...
	public static void doUpdateUser(UserServicesRemote remote){
		...
		User user1=remote.findUserById(1);
		user1.setNickname("kbilelmodifié");
		user1.setPassword("passwordmod");
		user1.setAdress("admod");
		if(remote.updateUser(user1)){
			System.out.println("OK");
		}
		else
